...
date_str  = df.index[0].strftime("%d %b %Y") + " – " + df.index[-1].strftime("%d %b %Y")
ax.set_title(f"ZigZag Technical Analysis — {date_str} (30d, 5-min) — {TICKER}",
